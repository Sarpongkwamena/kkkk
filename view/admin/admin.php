    	...
    	<div class="wrapper">
			...
			<nav class="sidebar">
				...
				<ul class="list-unstyled menu-elements">
					...
					<li>
						<a class="scroll-link" href="#section-1"><i class="fas fa-cog"></i> Brands</a>
					</li>
					<li>
						<a class="scroll-link" href="#section-4"><i class="fas fa-user"></i> Products</a>
					</li>
					<li>
			        ...
			        <div class="container">
			            <div class="row">
			                <div class="col col-md-10 offset-md-1 col-lg-8 offset-lg-2">
			                	<h1 class="wow fadeIn">ADMIN <strong>PANEL</strong></h1>
			                	<div class="description wow fadeInLeft">
			                		<p>
			                			Do what you want senior. Welcome
			                			<strong></strong></a>.
			                		</p>
			                	</div>
			                	<div class="buttons wow fadeInUp">							
									<a class="btn btn-primary btn-customized scroll-link" href="#section-1" role="button">
										<i class="fas fa-book-open"></i> Do More
									</a>
								</div>
			                </div>
			            </div>
			            ...
			            <div class="row">
		                	<div class="col-md-4 section-1-box wow fadeInUp">
		                		<div class="row">
			                		...
			                		<div class="col-md-16">
			                    		<h3><a class="nav-link" href="addbrand.php">Edit Brand</a></h3>								
			                    		<p>Edit, add and delete a brand.</p>
			                    	</div>
			                    </div>
		                    </div>
		                    <div class="col-md-4 section-1-box wow fadeInDown">
			                	<div class="row">
			                		...
			                		<div class="col-md-16">
			                    		<h3><a class="nav-link" href="categories.php">Edit Categories</a></h3>
			                    		<p>Edit, add and delete a category.</p>
			                    	</div>
			                    </div>
		                    </div>
			            </div>
			        ...
			        <div class="container">
			            <div class="row">
			                <div class="col section-4 section-description wow fadeInLeftBig">
			                	<h2>PRODUCTS</h2>
			                    <p>
			                    	Add, delete and edit a brand. 
			                    </p>
			                </div>
			            </div>
			            <div class="row">
			            	<div class="col section-bottom-button wow fadeInUp">
		                        <a class="nav-link" href="addproduct.php" role="button">
				            		<i class="fas fa-envelope"></i> Edit Products
				            	</a>
			            	</div>
			            </div>
			        </div>

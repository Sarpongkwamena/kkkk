<?php
    ...
    function brand_update($brandname, $brandid) {
        //model class instance
        $bmodel = new Brand_class();
        //run update brand method
        $run_update = $bmodel->brand_update($brandname, $brandid);
        if ($run_update) {
            return true;
        }
        else{
